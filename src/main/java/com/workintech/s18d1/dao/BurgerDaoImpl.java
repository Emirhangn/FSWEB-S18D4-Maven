...
public class BurgerDaoImpl implements BurgerDao{
    ...
    public List<Burger> findByPrice(Integer price) {
        TypedQuery<Burger> query = entityManager.createQuery("Select b From Burger b Where price>:price Order By b.price DESC", Burger.class);
    ...
    public List<Burger> findByBreadType(BreadType breadType) {
        TypedQuery<Burger> query = entityManager.createQuery("Select b From Burger b Where breadType=:breadType Order By b.name DESC", Burger.class);
